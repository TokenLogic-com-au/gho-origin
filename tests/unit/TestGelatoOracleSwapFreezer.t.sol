...
contract TestGsmOracleSwapFreezer is TestGhoBase {
  GelatoOracleSwapFreezer swapFreezer;
  ...
  function setUp() public {
    ...
    swapFreezer = new GelatoOracleSwapFreezer(
      GHO_GSM,
      address(USDX_TOKEN),
  ...
  function testCheckUpkeepCannotUnfreeze() public {
    GelatoOracleSwapFreezer swapFreezerWithoutUnfreeze = new GelatoOracleSwapFreezer(
      GHO_GSM,
      address(USDX_TOKEN),
      IPoolAddressesProvider(address(PROVIDER)),
      DEFAULT_FREEZE_LOWER_BOUND,
  ...
  function testFuzzUpkeepConsistency(uint256 assetPrice, bool grantRole) public {
    ...
    GelatoOracleSwapFreezer agent = new GelatoOracleSwapFreezer(
      GHO_GSM,
      address(USDX_TOKEN),
      IPoolAddressesProvider(address(PROVIDER)),
      DEFAULT_FREEZE_LOWER_BOUND,
