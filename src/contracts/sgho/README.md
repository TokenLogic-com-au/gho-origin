...
_This README reflects the current implementation as of the latest version. For the most precise technical details, refer to the contract source code and tests_
